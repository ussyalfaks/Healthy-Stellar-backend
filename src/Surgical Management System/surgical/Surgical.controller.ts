...
export class SurgicalController {
  ...
  async updateSurgicalCase(
    @Param("id") id: string,
    @Body() dto: UpdateSurgicalCaseDto,
  ) {
  ...
  async updateOperatingRoom(
    @Param("id") id: string,
    @Body() dto: UpdateOperatingRoomDto,
  ) {
  ...
  async getRoomUtilization(
    ...
    return this.surgicalService.getRoomUtilization(
      id,
      new Date(startDate),
      new Date(endDate),
    );
  ...
  async getStaffSchedule(
    ...
    return this.surgicalService.getStaffSchedule(
      staffId,
      new Date(startDate),
      new Date(endDate),
    );
  ...
  async updateSurgicalOutcome(
    @Param("id") id: string,
    @Body() dto: UpdateSurgicalOutcomeDto,
  ) {
