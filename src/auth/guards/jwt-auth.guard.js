...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function () {
        function JwtAuthGuard_1(authTokenService, sessionManagementService) {
            this.authTokenService = authTokenService;
            this.sessionManagementService = sessionManagementService;
        }
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, token, payload, isSessionValid, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.sessionManagementService.isSessionValid(payload.sessionId)];
                        case 2:
                            ...
                            return [4 /*yield*/, this.sessionManagementService.updateSessionActivity(payload.sessionId)];
                        case 3:
                            // Update session activity
                            _a.sent();
